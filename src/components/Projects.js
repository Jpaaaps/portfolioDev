...
const projects = [
	{ src: productcart, urlDeployed: 'https://festive-pike-347305.netlify.app/', urlGithub: 'https://github.com/Jpaaaps/dojo-react-product-cart', name: 'Dojo react product cart', description: 'Ce projet n\'en est pas réellement un. Durant un dojo de l\'école nous devions créer une liste de commande, je vous laisse tester les différentes fonctionnalités'},
