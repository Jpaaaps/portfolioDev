...
const projects = [
  ...
  { src: pimp, urlDeployed: '', urlGithub: 'https://drive.google.com/drive/folders/1IJDzqJSmsh1n__rzqOL6Ba22ZIn6z-OI?usp=sharing', name: 'Pimp Your Waste', description: 'Troisième et dernier projet de ma formation, pour un client réel qui voulait un site interne de gestion de leur stock avec création d\'un front et d\'un back fonctionnel.'},
  { src: productcart, urlDeployed: 'https://festive-pike-347305.netlify.app/', urlGithub: '', name: 'Dojo react product cart', description: 'Ce projet n\'en ai pas réellement un. Durant un dojo de l\'école nous devions créer un product cart, je te laisse tester les fonctionnalités' },
	...
	{ src: tictac, urlDeployed: '', urlGithub: 'https://github.com/Jpaaaps/test_tictactrip', name: 'Test site de réservation', description: 'Début d\'une reproduction  d\'un site de réservation de voyage, pas encore le temps de le términer.' }
]
